...
PATH={{ nginx_upload_prefix }}/sbin:/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin:
DESC="Nginx Daemon"
DAEMON={{ nginx_upload_bin_file }}
CONF={{ nginx_upload_conf_file }}
PID={{ nginx_upload_pid_file }}
SCRIPT={{ nginx_upload_service_file }}
