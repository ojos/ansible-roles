...
pidfile = '{{ gunicorn_pid_directory }}/{{ gunicorn_pid_file }}'
worker_tmp_dir = {{ gunicorn_worker_tmp_directory }}
user = '{{ gunicorn_user }}'
group = '{{ gunicorn_group }}'
umask = {{ gunicorn_umask }}
tmp_upload_dir = {{ gunicorn_tmp_upload_directory }}
#secure_scheme_headers = {{ gunicorn_secure_scheme_headers }}
accesslog = '{{ gunicorn_log_directory }}/{{ gunicorn_accesslog }}'
access_log_format = '{{ gunicorn_access_log_format }}'
errorlog = '{{ gunicorn_log_directory }}/{{ gunicorn_errorlog }}'
