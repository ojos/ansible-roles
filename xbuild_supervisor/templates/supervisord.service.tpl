...
DAEMON={{ xbuild_supervisor_python_bin_directory }}/supervisord
CTL={{ xbuild_supervisor_python_bin_directory }}/supervisorctl
PID={{ xbuild_supervisor_pid_directory }}/{{ xbuild_supervisor_pid_file_name }}
CONF={{ xbuild_supervisor_conf_directory }}/{{ xbuild_supervisor_conf_file_name }}
